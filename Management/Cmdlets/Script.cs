...
namespace Eagle._Cmdlets
{
    ...
    public abstract class Script : Cmdlet, IDisposable
    {
        ...
        //       8. We want to provide a "safe" subset of commands.
        //
        ...
        protected Script()
        {
            ...
            createFlags = Interpreter.GetStartupCreateFlags(null,
                DefaultCreateFlags, OptionOriginFlags.Standard, console,
                true);

            //
            // NOTE: By default, use the default initialization, script, and
            //       interpreter behavior flags.
            //
        ...
        {
            return WriteFlags(
                flagsCallback, createFlags, initializeFlags, scriptFlags,
                interpreterFlags);
        }
            ...
            )
        {
            ...
            return WriteFlags(
                callback, createFlags, initializeFlags, scriptFlags,
                interpreterFlags, ref error);
        }
        ...
        protected override void BeginProcessing()
        {
            ...
            try
            {
                ...
                //
                ExecuteCallbackDictionary localPolicies = null;

                if (policies)
                {
                    localPolicies = new ExecuteCallbackDictionary(
                        new ExecuteCallback[] {
                ...
                interpreter = Interpreter.Create(
                    null, createFlags, initializeFlags, scriptFlags,
                    interpreterFlags, null, this, null, null, localPolicies,
                    null, preInitialize, null, null, ref result); /* throw */
