...
namespace Eagle._Constants
{
    ...
    internal static class SnapIn
    {
        public static readonly string Description = String.Format(
            "This Windows PowerShell snap-in contains cmdlets to interact with " +
            "Eagle, the Tcl {0} compatible scripting language for the Common " +
            "Language Runtime (CLR).", Utility.GetTclVersion());
