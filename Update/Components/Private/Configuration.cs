    ...
    internal sealed class Configuration
    {
            ...
            )
        {
            if (release != null)
            {
                ...
                return new Configuration(
                    Defaults.Assembly, Defaults.SubjectName, null, release.Id,
                    release.ProtocolId, release.PublicKeyToken, Defaults.Delay,
                    Defaults.MutexName, release.BaseUri,
                    Defaults.TagPathAndQuery, uriFormat, release.Name,
                    release.Culture, release.PatchLevel, Defaults.BuildType,
                    Defaults.ReleaseType, Defaults.StrongNameExFlags,
                    Defaults.SignatureFlags, null, Defaults.CoreFileName,
                    Defaults.HashAlgorithmName, Defaults.CommandFormat,
                    Defaults.ArgumentFormat, null, Defaults.TraceCallback,
                    Defaults.ShellArgs, Defaults.NoAuthenticodeSigned,
                    Defaults.NoStrongNameSigned, Defaults.CoreIsAssembly,
                    Defaults.WhatIf, Defaults.Verbose, Defaults.Silent,
                    Defaults.Invisible, Defaults.Force, Defaults.ReCheck,
                    Defaults.Tracing, Defaults.Logging, Defaults.Shell,
                    Defaults.Confirm);
            }
            ...
            try
            {
                ...
                for (int index = 0; index < length; index++)
                {
                    ...
                    else
                    {
                        ...
                        //
                        if ((index > 0) ||
                            !String.Equals(arg, assembly.Location,
