...
namespace Eagle._Containers.Public
{
    ...
    public sealed class ElementDictionary : Dictionary<string, object>
    {
        ...
        //
        private Dictionary<string, VariableFlags> elementFlags;
        #endregion
        ...
        private ElementDictionary(
            ...
            : base(info, context)
        {
            elementFlags = (Dictionary<string, VariableFlags>)info.GetValue(
                "elementFlags", typeof(Dictionary<string, VariableFlags>));
        }
#endif
        #endregion
            ...
            )
        {
            ...
            elementFlags = new Dictionary<string, VariableFlags>();
        }
