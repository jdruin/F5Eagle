...
namespace Eagle._Containers.Private
{
            ...
            Dictionary<TKey, TValue>, IDictionary<TKey, TValue>
    {
        ...
        private void UpdateChangeCountAndMaybeEpoch()
        {
            if (changeEpoch == null)
                changeEpoch = Now;
            ...
            )
        {
            ...
            if ((key != null) && (accessed != null) &&
                accessed.TryGetValue(key, out anyPair) && (anyPair != null))
            {
                return anyPair.X;
            }
            ...
            )
        {
            ...
            if ((dateTime != null) && (keysAccessed != null))
            {
                ...
                if (keysAccessed.TryGetValue(dateTime, out keys) &&
                    (keys != null) && keys.Remove(key) && (keys.Count == 0))
                {
        ...
        TValue IDictionary<TKey, TValue>.this[TKey key]
        {
            ...
            set
            {
                ...
                UpdateAccessed(key, Now, true);
                UpdateMaximumCount();
                UpdateChangeCountAndMaybeEpoch();
            }
        }
