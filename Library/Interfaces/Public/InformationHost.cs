...
namespace Eagle._Interfaces.Public
{
    ...
    public interface IInformationHost : IInteractiveHost
    {
        ...
        //
        bool WriteAnnouncementInfo(Interpreter interpreter, string value,
            bool newLine);
        bool WriteAnnouncementInfo(Interpreter interpreter, string value,
        ...
        void WriteHeader(Interpreter interpreter, InteractiveLoopData loopData,
            Result result);

        void WriteFooter(Interpreter interpreter, InteractiveLoopData loopData,
            Result result);
    }
}
