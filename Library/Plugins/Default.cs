...
namespace Eagle._Plugins
{
        ...
        IPlugin
    {
        ...
        ///   has been initialized.  It should only be set by the Initialize
        ...
        /// <summary>
        /// The auxiliary data associated with this plugin instance.  This is
        /// reserved for use by the plugin itself.  The core library does not
        /// use this property.
        /// </summary>
