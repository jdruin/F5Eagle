...
namespace Eagle._Hosts
{
    ...
    public class Wrapper : IHost, IDisposable
    {
        #region Private Data
        //
            ...
            )
        {
            ...
            if (hostData != null)
            {
                ...
                this.UseAttach = hostData.UseAttach;
                this.NoColor = hostData.NoColor;
                this.NoTitle = hostData.NoTitle;
                this.NoIcon = hostData.NoIcon;
                this.NoProfile = hostData.NoProfile;
                this.NoCancel = hostData.NoCancel;
            }
        }
        #endregion
            ...
            )
        {
            ...
            return baseHost.GetStream(
                path, mode, access, share, bufferSize, options, ref flags,
                ref fullPath, ref stream, ref error);
        }

        ///////////////////////////////////////////////////////////////////////

        public virtual ReturnCode GetScript(
            string name,
            ...
            )
        {
            ...
            return baseHost.CreateThread(
                start, maxStackSize, userInterface, isBackground, ref thread,
                ref error);
        }
            ...
            )
        {
            ...
            return baseHost.WriteAnnouncementInfo(interpreter, value, newLine);
        }
            ...
            )
        {
            ...
            return baseHost.WriteAnnouncementInfo(
                interpreter, value, newLine, foregroundColor, backgroundColor);
        }
