...
namespace Eagle._Hosts
{
        ...
        IHost, IDisposable
    {
        ...
        protected static readonly BindingFlags HostPropertyBindingFlags =
        ...
        //
        protected static IDictionary<string, string> wellKnownScriptNames =
            new StringDictionary(new string[]  {

            ///////////////////////////////////////////////////////////////////////////////////////////

            ScriptTypes.Initialization, ScriptTypes.Embedding,
            ScriptTypes.Vendor, ScriptTypes.Safe,
            ScriptTypes.Shell, ScriptTypes.Test,
            ScriptTypes.PackageIndex, ScriptTypes.All,
            ScriptTypes.Constraints, ScriptTypes.Epilogue,
            ScriptTypes.Prologue,

            ///////////////////////////////////////////////////////////////////////////////////////////

            FileNameOnly.Initialization, FileNameOnly.Embedding,
            FileNameOnly.Vendor, FileNameOnly.Safe,
            FileNameOnly.Shell, FileNameOnly.Test,
            FileNameOnly.LibraryPackageIndex, FileNameOnly.All,
            FileNameOnly.Constraints, FileNameOnly.Epilogue,
            ...
            FileName.Vendor, FileName.Safe,
            FileName.Shell, FileName.Test,
            FileName.LibraryPackageIndex, FileName.All,
            FileName.Constraints, FileName.Epilogue,
            FileName.Prologue, FileName.TestPackageIndex
        }, true, false);
        #endregion
        #endregion
        ...
        private Default()
        {
            ...
            //
            // NOTE: Set the defaults for the exit-related properties.
            //
            canExit = DefaultCanExit;
            canForceExit = DefaultCanForceExit;
            ...
            : this()
        {
            if (hostData != null)
            {
                ...
                //
                // NOTE: Try to attach to the existing console?
                //
                useAttach = hostData.UseAttach;

                //
                // NOTE: Allow colors to be disabled.
                //
                noColor = hostData.NoColor;

                //
                // NOTE: Allow setting the host title to be disabled.
                //
                noTitle = hostData.NoTitle;

                //
                // NOTE: Allow setting the host icon to be disabled.
                //
                noIcon = hostData.NoIcon;

                //
                // NOTE: Allow loading of the host profile to be disabled.
                //
                noProfile = hostData.NoProfile;

                //
                // NOTE: Allow the script cancellation interface to be disabled.
                //
                noCancel = hostData.NoCancel;
            }
        ...
        private bool replaceNewLines = true;
        protected internal virtual bool ReplaceNewLines
        {
            get { return replaceNewLines; }
            ...
            )
        {
            ...
            if (type != null)
            {
                foreach (PropertyInfo propertyInfo in type.GetProperties(HostPropertyBindingFlags))
                {
                    if (propertyInfo != null)
                    {
                        ...
                        {
                            if ((pattern == null) ||
                                StringOps.Match(null, mode, propertyInfo.Name, pattern, noCase))
                            {
            ...
            )
        {
            if (interactiveHost != null)
            {
                ...
                if (
                    ...
                    (type == typeof(_Hosts.Diagnostic)) || (type == typeof(_Hosts.Null)) ||
                    ...
                    do
                    {
                        ...
                        try
                        {
                            value = type.InvokeMember(
                                name, MarshalOps.HostInfoBindingFlags,
                                null, host, null);
                        }
                        catch (Exception e)
                        {
            ...
            )
        {
            ...
            if ((objectWrapper != null) && (objectWrapper.@object != null))
                return objectWrapper.@object.GetType();
            ...
            )
        {
            ...
            if (@object != null)
            {
                try
                {
                    list.Add(GetPairKeyWithPrefix("ReferenceCount", prefix),
                        @object.ReferenceCount.ToString());

                    list.Add(GetPairKeyWithPrefix("TemporaryReferenceCount", prefix),
                        @object.TemporaryReferenceCount.ToString());

                    list.Add(GetPairKeyWithPrefix("ObjectFlags", prefix),
                        @object.ObjectFlags.ToString());

#if NATIVE && TCL
                    list.Add(GetPairKeyWithPrefix("InterpName", prefix),
                        (@object.InterpName != null) ? @object.InterpName :
                        FormatOps.DisplayNull);
#endif

#if DEBUGGER && DEBUGGER_ARGUMENTS
                    list.Add(GetPairKeyWithPrefix("ExecuteArguments", prefix),
                    ...
                    if (objectType != null)
                    {
                        ...
                        {
                            list.Add(GetPairKeyWithPrefix("ObjectType", prefix),
                                objectType.FullName);
                        }
                        else
                        {
                    ...
                    if (@object.Value != null)
                    {
                        ...
                        {
                            list.Add(GetPairKeyWithPrefix("ValueType", prefix),
                                valueType.FullName);
                        }
                        else
                        {
                        ...
                        list.Add(GetPairKeyWithPrefix("ToString", prefix),
                            @object.Value.ToString());
                    }
                    else
                    {
                        list.Add(GetPairKeyWithPrefix("Value", prefix),
                            FormatOps.DisplayNull);
                    }
            ...
            )
        {
            ...
            if (variable != null)
            {
                ...
                if (!isArray)
                {
                    Type type = (variable.Value != null) ?
                        variable.Value.GetType() : typeof(object);

                    string value = (variable.Value != null) ?
                        StringOps.GetStringFromObject(variable.Value) :
                        FormatOps.DisplayNull;
                ...
                if (variable.Frame != null)
                {
                    list.Add((IPair<string>)null);
                    list.Add("Frame");
                    list.Add((IPair<string>)null);

                    ICallFrame link = variable.Frame;
                    int count = 0;
                ...
                if (variable.Traces != null)
                {
                    list.Add((IPair<string>)null);
                    list.Add("Traces",
                        variable.Traces.Count.ToString());

                    if (variable.Traces.Count > 0)
                    {
                        list.Add((IPair<string>)null);

                        foreach (ITrace trace in variable.Traces)
                        {
                            if (trace != null)
                            {
                                //
            ...
            if (interpreter != null)
            {
                ...
                if (empty || (isolatedHost != null))
                    list.Add("IsolatedHost", (isolatedHost != null) ?
                        GetHostType(isolatedHost) : FormatOps.DisplayNull);
#endif

                if (empty || (interactiveHost != null))
                    list.Add("InteractiveHost", (interactiveHost != null) ?
                        GetHostType(interactiveHost) : FormatOps.DisplayNull);
                ...
                if (host != null)
                {
                    ...
                    if (defaultHost != null)
                    {
                        ...
                        List<PropertyInfo> colorPropertyList = colors ? GetColorProperties(
                            GetType(), MatchMode.None, null, false, true, false) : null;

                        if (colors &&
                            (colorPropertyList != null) && (colorPropertyList.Count > 0))
                        {
                            StringPairList localList = new StringPairList();

                            foreach (PropertyInfo propertyInfo in colorPropertyList)
                            {
                                if (propertyInfo != null)
                                {
                    ...
                    if (coreHost != null)
                    {
                        ...
                        if (empty || (coreHost.TypeName != null))
                            localList.Add("TypeName", (coreHost.TypeName != null) ?
                                coreHost.TypeName : FormatOps.DisplayNull);

                        if (empty || (coreHost.LibraryResourceBaseName != null))
                            localList.Add("LibraryResourceBaseName", (coreHost.LibraryResourceBaseName != null) ?
                                coreHost.LibraryResourceBaseName : FormatOps.DisplayNull);

                        if (empty || (coreHost.LibraryResourceManager != null))
                            localList.Add("LibraryResourceManager", (coreHost.LibraryResourceManager != null) ?
                                coreHost.LibraryResourceManager.ToString() : FormatOps.DisplayNull);

                        if (empty || (coreHost.PackagesResourceBaseName != null))
                            localList.Add("PackagesResourceBaseName", (coreHost.PackagesResourceBaseName != null) ?
                                coreHost.PackagesResourceBaseName : FormatOps.DisplayNull);

                        if (empty || (coreHost.PackagesResourceManager != null))
                            localList.Add("PackagesResourceManager", (coreHost.PackagesResourceManager != null) ?
                                coreHost.PackagesResourceManager.ToString() : FormatOps.DisplayNull);

                        if (empty || (coreHost.ApplicationResourceBaseName != null))
                            localList.Add("ApplicationResourceBaseName", (coreHost.ApplicationResourceBaseName != null) ?
                                coreHost.ApplicationResourceBaseName : FormatOps.DisplayNull);

                        if (empty || (coreHost.ApplicationResourceManager != null))
                            localList.Add("ApplicationResourceManager", (coreHost.ApplicationResourceManager != null) ?
                                coreHost.ApplicationResourceManager.ToString() : FormatOps.DisplayNull);

                        if (empty || (coreHost.ResourceManager != null))
                            localList.Add("ResourceManager", (coreHost.ResourceManager != null) ?
                                coreHost.ResourceManager.ToString() : FormatOps.DisplayNull);

                        if (empty || (coreHost.CoreScriptFlags != ScriptFlags.None))
                            localList.Add("CoreScriptFlags", coreHost.CoreScriptFlags.ToString());

                        if (empty || (coreHost.HostProfileFileEncoding != null))
                            localList.Add("HostProfileFileEncoding", (coreHost.HostProfileFileEncoding != null) ?
                                coreHost.HostProfileFileEncoding.WebName : FormatOps.DisplayNull);

                        if (empty || (coreHost.HostProfileFileName != null))
                            localList.Add("HostProfileFileName", (coreHost.HostProfileFileName != null) ?
                                coreHost.HostProfileFileName : FormatOps.DisplayNull);
            ...
            )
        {
            ...
            list.Add("ThrowOnDisposed",
                Engine.IsThrowOnDisposed(null, false).ToString());
...
#if NATIVE && WINDOWS
            ulong extraSpace = Engine.GetExtraStackSpace();
...
#if NATIVE && ((TCL && NATIVE_PACKAGE) || NATIVE_UTILITY)
        ...
        {
            return FlagOps.HasFlags(GetHostFlags(), HostFlags.Test, true);
        }
        ...
        {
            return FlagOps.HasFlags(GetTestFlags(), hasFlags, all);
        }
        #endregion
        ...
        {
            return FlagOps.HasFlags(GetHostFlags(), HostFlags.AutoFlushWriter, true);
        }
        #endregion
            ...
            ) /* CANNOT RETURN NULL */
        {
            ...
            if (FlagOps.HasFlags(
                    GetHostFlags(), HostFlags.NoColorNewLine, true))
            {
        ...
        {
            return FlagOps.HasFlags(GetHostFlags(), HostFlags.AutoFlushHost, true);
        }
                        ...
                        foreach (int pass in passes)
                        {
                            ...
                            finally
                            {
                                if (shouldColorForPass)
                                    /* IGNORED */
                                    SetColors(true, true, savedForegroundColor, savedBackgroundColor);
                            }
                        }
        ...
        protected virtual string GetBoxCharacterSet() /* MAY RETURN NULL */
        {
            ...
            if ((index < 0) || (index >= boxCharacterSets.Length))
                return null;
        ...
        {
            return FlagOps.HasFlags(GetHostFlags(), HostFlags.AllColors, false);
        }
        ...
        {
            return FlagOps.HasFlags(GetHostFlags(), HostFlags.AdjustColor, false);
        }
        ...
        {
            return FlagOps.HasFlags(GetHostFlags(), HostFlags.Sizing, true);
        }
        ...
        {
            return FlagOps.HasFlags(GetHostFlags(), HostFlags.Positioning, true);
        }
        ...
        {
            return FlagOps.HasFlags(GetHostFlags(), HostFlags.ReversedColor, true);
        }
        ...
        public abstract ReturnCode GetScript(
            string name,
            ...
            )
        {
            ...
            return WriteError(value, newLine, foregroundColor, ErrorBackgroundColor);
        }
            ...
            )
        {
            ...
            #region Break-On-Exiting Code
            //
            // NOTE: This block of code was primarily designed to catch
            //       termination and/or resource disposal errors encountered
            //       during the disposal of the Interpreter class (e.g. those
            //       raised by plugins).  Originally, this code was added while
            //       tracking down a particular interpreter disposal issue and
            //       it was intended to be temporary; however, it ended up
            //       being far too useful to remove.
            //
#if BREAK_ON_EXITING
            //
            // NOTE: If we (the host) is exiting, complain loudly about non-Ok
            //       return codes.
            //
            if (exiting)
            {
                //
                // NOTE: Prevent infinite recursion because the DebugOps methods
                //       call this function.
                //
                exiting = false;
                ...
                if (returnCode != ReturnCode.Ok)
                {
                    ...
                    if (DebugOps.IsAttached())
                    {
                        ...
                        //
                        DebugOps.Break(null, this, DebugOps.GetMethod(0),
                            false);
                    }
                    else
                    {
                        ...
                        string message = String.Format(
                            "received failure return code {0} while exiting",
                            returnCode);

                        DebugOps.Fail(
                            null, this, DebugOps.GetMethod(0), message, result,
                            false);
                    }
                }
            ...
            )
        {
            ...
            return WriteAnnouncementInfo(
                interpreter, value, newLine, AnnouncementInfoForegroundColor,
            ...
            )
        {
            ...
            if (!Write(StringOps.PadCenter(
                    value, ContentWidth - ContentMargin, Characters.Space),
            ...
            )
        {
            ...
            HostFlags hostFlags = autoSize ? GetHostFlags() : HostFlags.None;
                ...
                try
                {
                    ...
                    try
                    {
                                            ...
                                            if ((element != null) && (toString != null))
                                            {
                                                ...
                                                if ((element.X != null) && (element.Y != null))
                                                {
                                                    ...
                                                    value = StringOps.NormalizeWhiteSpace(
                                                        ...
                                                        Characters.Space, WhiteSpaceFlags.BoxUse);
                                                ...
                                                {
                                                    value = StringOps.NormalizeWhiteSpace(
                                                        element.X, Characters.Space, WhiteSpaceFlags.BoxUse);
                                                ...
                                                {
                                                    value = StringOps.NormalizeWhiteSpace(
                                                        element.Y, Characters.Space, WhiteSpaceFlags.BoxUse);
                        ...
                        DebugOps.Complain(ReturnCode.Error,
                            "cannot write box, insufficient space");
#endif
            ...
            )
        {
            ...
            return (!foreground || SetForegroundColor(foregroundColor)) &&
        ...
        public virtual bool ResetFlags()
        {
            CheckDisposed();
