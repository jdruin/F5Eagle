    ...
    public class Diagnostic : Core, IDisposable
    {
            ...
            )
        {
            ...
            return new Diagnostic(new HostData(
                Name, Group, Description, ClientData, typeof(Diagnostic).Name,
                interpreter, ResourceManager, Profile, UseAttach, NoColor,
