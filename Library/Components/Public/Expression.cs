...
namespace Eagle._Components.Public
{
    ...
    public class ExpressionToken : ParseToken, IExpressionToken
    {
        ...
        {
            return FromState(interpreter, parseState, exprState, Lexeme.Unknown);
        }
        ...
        {
            return FromState(interpreter, parseState, exprState, null, lexeme);
        }
        ...
        {
            return new ExpressionToken(this, this.Lexeme,
                new Variant(this.Variant) /* deep copy */);
        }
        #endregion
    }
    #endregion
        ...
        ICloneable, IExpressionState
    {
        ...
        {
            IExpressionState state = new ExpressionState(this);
            ...
            if (parseState != null)
                state.ParseState = (IParseState)((ICloneable)parseState).Clone(); /* deep copy */
    ...
    public static class ExpressionParser
    {
            ...
            ) /* ENTRY-POINT, THREAD-SAFE, RE-ENTRANT */
        {
            ...
            exprState.ParseState = parseState;
            ...
            )
        {
            ...
            IExpressionToken subToken;
            IExpressionToken operatorToken;
            int firstIndex;
            int sourceStart;
            ...
            )
        {
                   ...
                   (lexeme == Lexeme.StringContains))
            {
                ...
                if (lexeme == Lexeme.Equal)
                ...
                else if (lexeme == Lexeme.StringNotEqual)
                    operatorLength = Operators.StringNotEqual.Length;
                else if (lexeme == Lexeme.StrStartsWith)
                    ...
                    operatorLength = Operators.StrEndsWith.Length;
                code = GetLexeme(interpreter, exprState, noReady, ref error);
            ...
            )
        {
            ...
            switch (lexeme)
            {
                ...
                case Lexeme.FunctionName:
                    {
                        IExpressionState savedExprState = (IExpressionState)((ICloneable)exprState).Clone();
                        ...
                        {
                            string value =
                                parseState.Text.Substring(savedExprState.Start, savedExprState.Length);
                            ...
                            {
                                exprState = (IExpressionState)((ICloneable)savedExprState).Clone();
                        ...
                        token.Start = savedExprState.Start;
                        token.Length = savedExprState.Length;
                        token.Components = 0;
            ...
            retryNumber:
                    ...
                    ((length = ParseInteger(parseState.Text, index, end - index)) > 0))
                {
                    ...
                    if (Value.GetUnsignedWideInteger2(
                            ...
                            cultureInfo, ref ulongValue, ref localError) == ReturnCode.Error)
                    {
                ...
                else if ((length = ParseMaxDoubleLength(parseState.Text, index, end)) > 0)
                {
                    ...
                    if ((Value.GetDouble2(value, cultureInfo, ref doubleValue, ref stopIndex,
                ...
                case Characters.c:
                    {
                        if (((exprState.Last - index) > 1) &&
                            ...
                            (parseState.Text[index + 2] == Characters.n) &&
                            (parseState.Text[index + 3] == Characters.t) &&
                            (parseState.Text[index + 4] == Characters.a) &&
                            (parseState.Text[index + 5] == Characters.i) &&
                            (parseState.Text[index + 6] == Characters.n) &&
                            (parseState.Text[index + 7] == Characters.s))
                        {
                            exprState.Lexeme = Lexeme.StringContains;
                            exprState.Length = 8;
                            exprState.Next = index + 8;
                            parseState.Terminator = exprState.Next;
                ...
                case Characters.e:
                    {
                            ...
                            (parseState.Text[index + 1] == Characters.q))
                        {
                            ...
                            (parseState.Text[index + 3] == Characters.s))
                        {
                            exprState.Lexeme = Lexeme.StrEndsWith;
                            exprState.Length = 9;
                            exprState.Next = index + 9;
                ...
                case Characters.s:
                    {
                        if (((exprState.Last - index) > 1) &&
                            (parseState.Text[index + 1] == Characters.t) &&
                            (parseState.Text[index + 2] == Characters.a) &&
                            (parseState.Text[index + 3] == Characters.r) &&
                            (parseState.Text[index + 4] == Characters.t) &&
                            (parseState.Text[index + 5] == Characters.s))
                        {
                            
                            exprState.Lexeme = Lexeme.StrStartsWith;
                            exprState.Length = 11;
                            exprState.Next = index + 11;
                ...
                checkFuncName:
#endif
                    {
                        ...
                        if (Char.IsLetter(character))
                        {
                            ...
                            exprState.Lexeme = Lexeme.FunctionName;
    ...
    internal static class ExpressionEvaluator
    {
            ...
            ) /* ENTRY-POINT, THREAD-SAFE, RE-ENTRANT */
        {
            ...
            if ((index < 0) || (index >= parseState.Tokens.Count))
            {
                error = String.Format(
                    "initial token index {0} is out of bounds, have {1} " +
                    "tokens", index, parseState.Tokens.Count);

                return ReturnCode.Error;
            }

            IExpressionToken firstToken = ExpressionToken.FromToken(
                interpreter, parseState.Tokens[index]);
                ...
                case TokenType.SubExpression:
                    {
                        code = EvaluateSubExpression(
                            ...
                            executeResultLimit, nestedResultLimit,
#endif
                            noReady, ref usable, ref exception, ref value,
                            ref error);
                ...
                case TokenType.Function:
                    {
                        ...
                        if (interpreter.GetOperator(
                                name, LookupFlags.ExpressionNoVerbose,
                                ref @operator) != ReturnCode.Ok)
                        {
                            IFunction function = null;

                            if ((code = interpreter.GetFunction(
                                    name, LookupFlags.ExpressionDefault,
                                    ref function, ref error)) == ReturnCode.Ok)
                            {
#if EXPRESSION_FLAGS
                                //
                                ...
                                @operator.Flags, OperatorFlags.Special, true))
                        {
                            ...
                            code = EvaluateSubExpression(
                                ...
                                executeResultLimit, nestedResultLimit,
#endif
                                noReady, ref usable, ref exception, ref operand1,
                                ref error);
                            ...
                            if (@operator.Operands == 2)
                            {
                                ...
                                code = EvaluateSubExpression(
                                    ...
                                    executeResultLimit, nestedResultLimit,
#endif
                                    noReady, ref usable, ref exception,
                                ...
                                case Lexeme.LogicalImp: // short circuit (if operand1 is FALSE)
                                    {
                                        ...
                                        code = Engine.ToBoolean(
                                            operand1, interpreter.CultureInfo,
            ...
            if (usable)
            {
                ...
                //       final result.
                //
                if (interpreter.ExitExpressionLevel() == 0) /* SIDE-EFFECT */
                {
                    if ((code == ReturnCode.Ok) && (value != null))
                    {
                        try
                        {
                            ...
                            //       expression flag has been set, then
                            //       automatically convert the value to an
                            //       integer instead (COMPAT: Tcl).
                            //
                            else if ((value.Value is bool) &&
                                HasBooleanToInteger(expressionFlags))
                            {
                                value = ConversionOps.ToInt((bool)value.Value);
                            }
                        }
                        catch (Exception e)
                        {
            ...
            else
            {
                ...
                //       message.
                //
                error = Engine.InterpreterUnusableError;
                code = ReturnCode.Error;
            }
