    ...
    public sealed class Event : IEvent, IDisposable
    {
            ...
            )
        {
            return new Event(
                ...
                name, dateTime, callback, clientData);
        }
        #endregion
            ...
            )
        {
            ...
            try
            {
                GetResultData(ref returnCode, ref result, ref errorLine);
            }
            finally
            {
                if (syncRoot != null)
            ...
            )
        {
            ...
            if ((syncRoot != null) &&
                !Monitor.TryEnter(syncRoot, milliseconds))
            {
                return false;
            }
            ...
            )
        {
            ...
            try
            {
                if (wait && !WaitOnEventHandle(milliseconds, ref error))
                    return false;

                if (!GetResult(
                        milliseconds, ref returnCode, ref result,
                        ref errorLine))
                {
                    return false;
                }
            ...
            )
        {
            ...
            try
            {
                if (!SetResult(milliseconds, returnCode, result, errorLine))
                    return false;
