...
namespace Eagle._Components.Public
{
        ...
        IValue, ICloneable
    {
        ...
        {
            //
            // NOTE: Implicitly allow all Enum values.
            //
            return (((type != null) && type.IsEnum) || HaveType(type));
        }
        ...
        {
            return ((value == null) || IsSupported(null, value.GetType()));
        }
        ...
        public virtual object Value /* throw */
        {
            ...
            set
            {
                if ((value == null) || IsSupported(value.GetType()))
                {
                    numberValue = value;
                }
                else
                {
                    throw new ScriptException("could not set number value",
                        new ArgumentException(String.Format(
                            "number does not accept type \"{0}\"",
                                /* value != null */ value.GetType().Name)));
                }
            }
        }
