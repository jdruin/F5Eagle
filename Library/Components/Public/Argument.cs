...
namespace Eagle._Components.Public
{
            ...
            ICanHashValue, ICloneable
    {
        ...
        {
            return String.Compare(ToString(argument1, null),
                ToString(argument2, null), comparisonType);
        }
#endif
        #endregion
        #endregion
            ...
            )
        {
            ...
            if (!createOnly)
            {
                ...
                if ((interpreter != null) &&
                    interpreter.CanUseArgumentCache(ref argument))
                {
                    argument.Reset(false);
        ...
        [DebuggerStepThrough()]
        private static Argument FromList(
            IStringList value
            )
        {
            return PrivateCreate((object)value);
