...
namespace Eagle._Components.Private
{
    ...
    internal static class RegExOps
    {
            ...
            )
        {
            ...
            //
            // NOTE: Perform our custom replacements and return the result.
            //
            return !verbatim ? TranslateSubSpec(regEx,
                pattern, input, replacement, replacement, quote,
                extra, strict, match) : GetMatchValue(match);
        }
