...
namespace Eagle._Components.Private
{
    ...
    internal sealed class ScriptBinder : Binder, IScriptBinder, IHaveInterpreter
    {
            ...
            )
        {
            ...
            defaultBindingFlags = MarshalOps.DefaultBindingFlags;
            ...
            if (changeTypeData != null)
            {
                ...
                if (debug)
                {
                    ...
                    TraceOps.DebugTrace(String.Format(
                        ...
                        FormatOps.WrapOrNull((oldValue != null) ? oldValue.GetType() : null),
                        FormatOps.WrapOrNull(changeTypeData.MarshalFlags),
                        FormatOps.WrapOrNull(true, true, newValue),
                        FormatOps.WrapOrNull((newValue != null) ? newValue.GetType() : null),
            ...
            ) /* throw */
        {
            ...
            if (debug)
            {
                TraceOps.DebugTrace(String.Format(
                    ...
                    FormatOps.WrapOrNull((value != null) ? value.GetType() : null),
