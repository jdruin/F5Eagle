...
namespace Eagle._Components.Private
{
    ...
    internal static class NamespaceOps
    {
        ...
        private static readonly StringComparison comparisonType =
        ...
        {
            return Create(
                TclVars.GlobalNamespaceName, null, interpreter, null, null,
                (interpreter != null) ? interpreter.Unknown : null, null,
                false);
        }
            ...
            )
        {
            ...
            string separator = TclVars.NamespaceSeparator;
            int separatorLength = separator.Length;
            int length = name.Length;

            int index = name.IndexOf(
                separator, StringOps.SystemStringComparisonType);
            ...
            while (index != Index.Invalid)
            {
                ...
                index = name.IndexOf(
                    separator, index, StringOps.SystemStringComparisonType);
            }
            ...
            )
        {
            ...
            return TclVars.GlobalNamespace +
                list.ToString(TclVars.NamespaceSeparator, null, false);
        }
            ...
            )
        {
            ...
            if (name.Length == 0)
                return TclVars.GlobalNamespaceName;

            if (IsAbsoluteName(name))
                return name;

            return String.Format(
                AbsoluteNameFormat, TclVars.GlobalNamespace, name);
        }
        ...
        {
            //
            // HACK: Do not strip the leading colons from the qualifiers here
            //       because the caller may want them.
            //
            return String.Format(QualifiedNameFormat, trimAll ?
                TrimAll(qualifiers) : qualifiers, TclVars.NamespaceSeparator,
                trimAll ? TrimAll(tail) : tail);
        }
            ...
            if ((@namespace == null) || IsGlobal(interpreter, @namespace))
            {
                if (pattern != null)
                {
                    qualifiedPattern = MakeQualifiedName(
                        TclVars.GlobalNamespaceName, pattern, false);
                }
                else
                {
                    qualifiedPattern = MakeQualifiedName(
                        TclVars.GlobalNamespaceName,
            ...
            )
        {
            ...
            return new StringList(parts2, parts1.Length).ToString(
                TclVars.NamespaceSeparator, null, false);
        }
            ...
            )
        {
            if (qualifiers != null)
            {
                ...
                foreach (string name in SplitName(qualifiers))
                {
                    ...
                    if (newQualifiers.Length > 0)
                        newQualifiers.Append(TclVars.NamespaceSeparator);
            ...
            if (tail != null)
            {
                ...
                foreach (string name in SplitName(tail))
                {
                    ...
                    if (newTail.Length > 0)
                        newTail.Append(TclVars.NamespaceSeparator);
            ...
            )
        {
            ...
            int index = StringOps.LastIndexOf(
                name, separator, StringOps.SystemStringComparisonType);
        ...
        {
            return String.Equals(name1, name2, comparisonType);
        }
        #endregion
            ...
            )
        {
            ...
            return name.StartsWith(TclVars.GlobalNamespace, comparisonType);
        }
            ...
            )
        {
            ...
            return name.IndexOf(TclVars.NamespaceSeparator,
            ...
            )
        {
            ...
            result.Add(MakeAbsoluteName(
                GlobalState.GetPackageName()), TclVars.GlobalNamespace);
            ...
            )
        {
            ...
            if (String.IsNullOrEmpty(name))
            {
                if (create)
                {
                    error = String.Format(
                        ...
                        "namespace can have empty name", name);
                }
                else
                {
            ...
            foreach (string localName in SplitName(name))
            {
                ...
                if (childNamespace == null)
                {
                    if (create)
                    {
                        childNamespace = Create(
                            localName, null, interpreter, parentNamespace,
                            null, null, null, true);
                        ...
                        {
                            Dispose(interpreter, ref childNamespace);
                            break;
                        }
                    }
                    else
            ...
            )
        {
            ...
            if (absolute && (qualifiers != null))
                qualifiers = TclVars.GlobalNamespace + TrimLeading(qualifiers);

            return Lookup(
                interpreter, qualifiers, absolute, create, ref error);
        }
            ...
            )
        {
            ...
            return Lookup(interpreter, name, absolute, create, ref error);
        }
        ...
        {
            return Lookup(
                interpreter, null, name, absolute, create, ref error);
        }
            ...
            )
        {
            if (@namespace == null)
            {
                @namespace = GetBase(interpreter, name, absolute, ref error);
            ...
            return GetDescendant(
                interpreter, @namespace, name, create, ref error);
        }
            ...
            )
        {
            if (execute is IProcedure)
                name = MakeAbsoluteName(((IProcedure)execute).Name);
            else if (execute is ICommand)
                name = MakeAbsoluteName(((ICommand)execute).Name);
            else
            ...
            )
        {
            ...
            foreach (string localName in names)
            {
                        ...
                        ref execute, ref localError) == ReturnCode.Ok)
                {
                    ...
                    return NormalizeName(interpreter, ref name, ref error);
                }
                else
                {
                    if (errors == null)
        ...
        private static bool IsSameAliasName(
            IExecute execute,
            string name
            )
        {
            ...
            return String.Equals(GetAliasName(alias), name,
                StringOps.SystemStringComparisonType);
        }
        ...
        {
            IPluginData pluginData = interpreter.GetCorePlugin(ref error);
            ...
            ICommandData newCommandData = RuntimeOps.FindCommandData(
                pluginData, newType);

            if (newCommandData == null)
            {
            ...
            //
            // HACK: We know that these commands are not within an isolated
            //       plugin because the core plugin is never isolated.
            //
            ...
            if (interpreter.AddCommand(
                    command, null, ref newToken, ref error) == ReturnCode.Ok)
            {
            ...
            )
        {
            ...
            //
            if (ChangeCommand(interpreter, enable, ref error) != ReturnCode.Ok)
            {
                return ReturnCode.Error;
            }
            ...
            foreach (string pattern in patterns)
            {
                    ...
                    FlagOps.HasFlags(flags, NamespaceFlags.Qualified, true))
                {
                    result = String.Format(
                        "invalid export pattern \"{0}\": pattern can't " +
                        "specify a namespace", pattern);
            ...
            )
        {
            ...
            foreach (string pattern in patterns)
            {
                ...
                {
                    result = String.Format(
                        "import pattern \"{0}\" tries to import from " +
                        "namespace \"{1}\" into itself", pattern, @namespace);
                ...
                foreach (string exportName in exportNames)
                {
                    ...
                    foreach (KeyValuePair<string, object> pair in dictionary)
                    {
                                ...
                                ref command) == ReturnCode.Ok)
                        {
                            ...
                            //
                            if (IsSameAliasName(command, qualifiedExportName))
                                continue;
            ...
            )
        {
            ...
            error = null;
            @namespace = Lookup(interpreter, name, false, false, ref error);
            ...
            )
        {
            ...
            if (subCommand != null)
            {
                ...
                if (!String.Equals(list[1], subCommand,
                        StringOps.SystemStringComparisonType))
                {
                    return false;
                }
            ...
            )
        {
            ...
            if (FlagOps.HasFlags(flags, NamespaceFlags.Command, true))
            {
                ...
                if (interpreter.GetIExecuteViaResolvers(
                        interpreter.GetResolveEngineFlags(true),
                        qualifiedName, null, LookupFlags.NoVerbose,
                ...
                else
                {
                    ...
                    if (interpreter.GetIExecuteViaResolvers(
                            interpreter.GetResolveEngineFlags(true),
                            name, null, LookupFlags.NoVerbose,
                            ref execute) == ReturnCode.Ok)
                    {
                        result = absoluteName;
                        return ReturnCode.Ok;
            ...
            {
                VariableFlags variableFlags = VariableFlags.NamespaceWhichMask;
                IVariable variable = null;

                if (interpreter.GetVariableViaResolversWithSplit(
                        qualifiedAbsoluteName, ref variableFlags,
                ...
                {
                    variableFlags = VariableFlags.GlobalNamespaceWhichMask;
                    variable = null;
