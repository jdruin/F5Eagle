...
namespace Eagle._Components.Private
{
            ...
            IContextManager, IHaveInterpreter, IDisposable
    {
        ...
        private static int GetCurrentContextThreadId()
        {
        ...
        private static bool CanUseThreadContext(
            ...
            )
        {
            ...
            return (threadContext.ThreadId == GetCurrentContextThreadId());
        }

        ///////////////////////////////////////////////////////////////////////

        private static bool DisposeThreadContext(
            IThreadContext threadContext
            )
        {
            ...
            )
        {
            ...
            //       (assuming the "global" paramter is correct).
            //
                            ...
                            interpreter, out result))
                    {
                        ...
                        lock (interpreter.SyncRoot) /* TRANSACTIONAL */
                        {
                            ...
                            result = new VariableContext(interpreter,
                                GetCurrentContextThreadId(), callStack,
                                interpreter.InternalGlobalFrame, null,
                                null, null, null, null);
            ...
            )
        {
            if (!disposed)
            {
                if (disposing)
                {
                    ...
                    //       freed in that case.
                    //
                    if (!AppDomainOps.IsCurrentFinalizing())
                        Free(true);
                }
