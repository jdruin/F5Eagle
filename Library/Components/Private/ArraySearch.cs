...
namespace Eagle._Components.Private
{
    ...
    {
        #region Private Data
        private IEnumerator enumerator; /* NOTE: The master enumerator for this array variable. */

        private bool didMoveNext;       /* NOTE: Non-zero if we have called MoveNext at least once on
                                         *       the master enumerator. */

        private bool noMoreElements;    /* NOTE: Non-zero if the master enumerator has hit the end. */
        #endregion
        ...
        public bool AnyMore
        {
            get
            {
                ...
                //       on the master enumerator is going to return true; however, we do not
                //       actually want to change the state of the master enumerator in the
                ...
                //       advancing it until we hit the current element of the master enumerator.
                ...
                //       beyond the current element one in the master enumerator.  The primary
                //       problem with this approach is that it has the potential to be extremely
                //       inefficient in the worst case (i.e. if the master enumerator is
                ...
                {
                    //
                    // NOTE: If we have not fetched the first value from the master enumerator,
