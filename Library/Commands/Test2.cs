                ...
                if (arguments != null)
                {
                    if (arguments.Count >= 3)
                    {
                        ...
                        OptionDictionary options = new OptionDictionary(
                            ...
                            new Option(null, OptionFlags.MustHaveValue, Index.Invalid, Index.Invalid, "-errorOutput", null),
                            new Option(null, OptionFlags.MustHaveReturnCodeListValue, Index.Invalid, Index.Invalid, "-returnCodes", null),
                            new Option(typeof(ExitCode), OptionFlags.MustHaveEnumValue, Index.Invalid, Index.Invalid, "-exitCode", null),
                            ...
                            new Option(null, OptionFlags.MustHaveBooleanValue, Index.Invalid, Index.Invalid, "-debug", null),
                            new Option(null, OptionFlags.MustHaveBooleanValue, Index.Invalid, Index.Invalid, "-trace", null),
                            ...
                            new Option(null, OptionFlags.MustHaveValue, Index.Invalid, Index.Invalid, "-text", null),
                            new Option(null, OptionFlags.MustHaveListValue, Index.Invalid, Index.Invalid, "-argv", null),
                            ...
                            new Option(typeof(RegexOptions), OptionFlags.NoCase | OptionFlags.MustHaveEnumValue, Index.Invalid, Index.Invalid, "-regExOptions",
                            ...
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveIntegerValue, Index.Invalid, Index.Invalid, "-repeatCount", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveBooleanValue, Index.Invalid, Index.Invalid, "-noCancel", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveBooleanValue, Index.Invalid, Index.Invalid, "-noData", null),
                            ...
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveBooleanValue, Index.Invalid, Index.Invalid, "-noHalt", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveBooleanValue, Index.Invalid, Index.Invalid, "-noProcessId", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveBooleanValue, Index.Invalid, Index.Invalid, "-noStatistics", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveBooleanValue, Index.Invalid, Index.Invalid, "-noSecurity", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveValue, Index.Invalid, Index.Invalid, "-libraryPath", null),
#if ISOLATED_INTERPRETERS
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveValue, Index.Invalid, Index.Invalid, "-packagePath", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveValue, Index.Invalid, Index.Invalid, "-baseDirectory", null),
#else
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveValue | OptionFlags.Unsupported, Index.Invalid, Index.Invalid,
                                "-packagePath", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveValue | OptionFlags.Unsupported, Index.Invalid, Index.Invalid,
                                "-baseDirectory", null),
#endif
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveListValue, Index.Invalid, Index.Invalid, "-autoPath", null),
                            new Option(typeof(IsolationLevel), OptionFlags.NoCase | OptionFlags.MustHaveEnumValue, Index.Invalid, Index.Invalid, "-isolationLevel",
                                new Variant(IsolationLevel.Default)),
                            new Option(typeof(IsolationDetail), OptionFlags.NoCase | OptionFlags.MustHaveEnumValue, Index.Invalid, Index.Invalid, "-isolationPassDetail",
                                new Variant(IsolationDetail.Default)),
                            new Option(typeof(IsolationDetail), OptionFlags.NoCase | OptionFlags.MustHaveEnumValue, Index.Invalid, Index.Invalid, "-isolationFailDetail",
                                new Variant(IsolationDetail.Default)),
                            new Option(typeof(TestPathType), OptionFlags.NoCase | OptionFlags.MustHaveEnumValue, Index.Invalid, Index.Invalid, "-isolationPathType",
                                new Variant(TestPathType.Default)),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveBooleanValue, Index.Invalid, Index.Invalid, "-isolationUnicode", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveValue, Index.Invalid, Index.Invalid, "-isolationTemplate", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveValue, Index.Invalid, Index.Invalid, "-isolationFileName", null),
                            new Option(null, OptionFlags.NoCase | OptionFlags.MustHaveValue, Index.Invalid, Index.Invalid, "-isolationLogFile", null),
                        ...
                        if (code == ReturnCode.Ok)
                        {
                            ...
                            if (argumentIndex == Index.Invalid)
                            {
...
#endif
                                {
                                    ...
                                    if (options.IsPresent("-errorOutput", ref value))
                                    ...
                                    if (options.IsPresent("-returnCodes", ref value))
                                    ...
                                    if (options.IsPresent("-visibleSpace", ref value))
                                        ...
                                        try
                                        {
                                            ...
                                            if ((code == ReturnCode.Ok) && !skip)
                                            {
                                                ...
                                                try
                                                {
                                                        ...
                                                        case IsolationLevel.Interpreter:
                                                            {
                                                                ...
                                                                testInterpreter = Interpreter.Create(
                                                                    argv, testCreateFlags, testInitializeFlags,
                                                                    testScriptFlags, testInterpreterFlags, text,
                                                                    libraryPath, autoPathList, ref isolationResult);

                                                                if ((testInterpreter != null) && security)
                                                                {
                                                                    code = ScriptOps.EnableOrDisableSecurity(
                                                                        testInterpreter, true, ref isolationResult);
                                                                }
                                                                break;
                                                            }
                                                        ...
                                                        case IsolationLevel.AppDomainOrInterpreter:
                                                            {
                                                                ...
                                                                if (AppDomainOps.CreateForTest(
                                                                        ...
                                                                        packagePath, clientData, ref testAppDomain,
                                                                        ref isolationResult) == ReturnCode.Ok)
                                                                {
                                                                    ...
                                                                    testInterpreterHelper = InterpreterHelper.Create(
                                                                        testAppDomain, argv, testCreateFlags,
                                                                        testInitializeFlags, testScriptFlags,
                                                                        testInterpreterFlags, text, libraryPath,
                                                        ...
                                                        case IsolationLevel.Process:
                                                            {
                                                                ...
                                                                if (isolationTemplate != null)
                                                                {
                                                                    ...
                                                                    if (TestOps.GetIsolatedExecutableName(
                                                                            true, ref isolationExecutableName,
                                                                            ref isolationResult) == ReturnCode.Ok)
                                                                    {
                                                                        if ((isolationFileName != null) ||
                                                                            TestOps.GetIsolatedFileName(
                                                                                interpreter, isolationPathType,
                                                                                ...
                                                                                ref isolationResult) == ReturnCode.Ok)
                                                                        {
                                                                            ...
                                                                            if (TestOps.GetIsolatedExecutableArguments(
                                                                                    isolationFileName, isolationLogFile,
                                                                                    security, ref isolationExecutableArguments,
                                                                                    ref isolationResult) == ReturnCode.Ok)
                                                                            {
                                                                                        ...
                                                                                        ref isolationResult) == ReturnCode.Ok)
                                                                                {
                                                                                    ...
                                                                                    File.WriteAllText(
                                                                                        ...
                                                                                        isolationTemplate, new StringPairList(
                                                                                    ...
                                                                                    ReturnCode execCode;
                                                                                    int execProcessId = 0;
                                                                                    ExitCode execExitCode = ResultOps.SuccessExitCode();
                                                                                    Result execResult = null;
                                                                                    Result execError = null;

                                                                                    execCode = ProcessOps.ExecuteProcess(
                                                                                        interpreter, isolationExecutableName,
                                                                                        isolationExecutableArguments, null,
                                                                                        EventFlags.All, isolationUnicode,
                                                                                        ref execProcessId, ref execExitCode,
                                                                                        ref execResult, ref execError);
                                                                                    ...
                                                                                    if (time)
                                                                                    {
                                                                                        ...
                                                                                        TestOps.AppendFormat(
                                                                                            ...
                                                                                            name, execProcessId, FormatOps.Performance(
                                                                                            microseconds));
                                                                                    ...
                                                                                    //
                                                                                    bool execCodeFailure = (execCode != ReturnCode.Ok);

                                                                                    //
                                                                                    // NOTE: Did the child process return a non-success
                                                                                    //       exit code?
                                                                                    //
                                                                                    bool execExitFailure =
                                                                                        (execExitCode != ResultOps.SuccessExitCode());
                                                    ...
                                                    //       if necessary?
                                                    //
                                                    if ((code == ReturnCode.Ok) && (testInterpreter != null))
                                                    {
                                                        //
                                                        ...
                                                        while (iterationCount < repeatCount)
                                                        {
                                                            ...
                                                            //
                                                            // NOTE: Used to hold the result of the -setup script, if any.
                                                            //
                                                            ...
                                                            if (setup != null)
                                                            {
                                                                ...
                                                                try
                                                                {
                                                                    ...
                                                                    try
                                                                    {
                                                                        ...
                                                                        {
                                                                            /* IGNORED */
                                                                            testInterpreter.CopyErrorInformation(
                                                                                VariableFlags.None, ref setupResult);
                                                                        }
                                                                    }
                                                                    finally
                                                                    {
                                                                        ...
                                                                        {
                                                                            /* IGNORED */
                                                                            Engine.ResetCancel(testInterpreter,
                                                                                CancelFlags.Test2);
                                                                        }
                                                                        ...
                                                                        {
                                                                            /* IGNORED */
                                                                            Engine.ResetHalt(testInterpreter,
                                                                                CancelFlags.Test2);
                                                                        }
                                                                        ...
                                                                        //       "success".
                                                                        //
                                                                        if (noExit && testInterpreter.Exit)
                                                                        {
                                                                            testInterpreter.ExitCode = ResultOps.SuccessExitCode();
                                                                            testInterpreter.Exit = false;
                                                                        }
                                                            ...
                                                            //
                                                            // NOTE: Used to hold the result of the -body script, if any.
                                                            //
                                                            ...
                                                            if ((setupCode == ReturnCode.Ok) && (body != null))
                                                            {
                                                                ...
                                                                try
                                                                {
                                                                    ...
                                                                    try
                                                                    {
                                                                        ...
                                                                        bodyExitCode = testInterpreter.ExitCode;
                                                            ...
                                                            //
                                                            // NOTE: Used to hold the result of the -cleanup script, if any.
                                                            //
                                                                ...
                                                                try
                                                                {
                                                                    ...
                                                                    try
                                                                    {
                                                                        ...
                                                                        if (cleanupCode == ReturnCode.Error)
                                                                        {
                                                                            /* IGNORED */
                                                                            testInterpreter.CopyErrorInformation(
                                                                                VariableFlags.None, ref cleanupResult);
                                                                        }
                                                                    }
                                                                    finally
                                                                    {
                                                                ...
                                                                if (expectedOutput != null)
                                                                {
                                                                    ...
                                                                    if (outputData != null)
                                                                    {
                                                                        ...
                                                                        outputCode = TestOps.Match(
                                                                            testInterpreter, mode, outputData.ToString(),
                                                                            expectedOutput, noCase, null, regExOptions,
                                                                ...
                                                                if (expectedError != null)
                                                                {
                                                                    ...
                                                                    if (errorData != null)
                                                                    {
                                                                        ...
                                                                        errorCode = TestOps.Match(
                                                                            testInterpreter, mode, errorData.ToString(),
                                                                            expectedError, noCase, null, regExOptions,
                                                            ...
                                                            if (!setupFailure && !codeFailure)
                                                            {
                                                                if (expectedResult != null)
                                                                {
                                                                    scriptCode = TestOps.Match(
                                                                        ...
                                                                        expectedResult, noCase, null, regExOptions,
                                                ...
                                                finally
                                                {
                                                        ...
                                                        !Object.ReferenceEquals(testInterpreter, interpreter))
                                                    {
                                                        ...
                                                        disposeCode = ObjectOps.TryDispose(
                                                            testInterpreter, ref disposeError);
                                                    ...
                                                    if (testInterpreterHelper != null)
                                                    {
                                                        ...
                                                        disposeCode = ObjectOps.TryDispose(
                                                            testInterpreterHelper, ref disposeError);
                                                    ...
                                                    if (testAppDomain != null)
                                                    {
                                                        ...
                                                        unloadCode = AppDomainOps.Unload(
                                                            testAppDomain, clientData, ref unloadError);
                                    ...
                                    finally
                                    {
                                        ...
                                        {
                                            TraceOps.DebugTrace(
                                                e, typeof(Test2).Name, TracePriority.Command);
                                        }
                                    }
                                }
                            }
