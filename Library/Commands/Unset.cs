                    ...
                    if (arguments.Count >= 1)
                    {
                        if (arguments.Count > 1)
                        {
                            OptionDictionary options = new OptionDictionary(
                                new IOption[] {
                                new Option(null, OptionFlags.None, Index.Invalid, Index.Invalid, "-unlinkonly", null),
                                new Option(null, OptionFlags.None, Index.Invalid, Index.Invalid, "-nocomplain", null),
                                new Option(null, OptionFlags.None, Index.Invalid, Index.Invalid, "-remove", null),
                                new Option(null, OptionFlags.None, Index.Invalid, Index.Invalid, "-purge", null),
#if !MONO && NATIVE && WINDOWS
                                new Option(null, OptionFlags.None, Index.Invalid, Index.Invalid, "-zerostring", null),
                                new Option(null, OptionFlags.None, Index.Invalid, Index.Invalid, "-maybezerostring", null),
#else
                                new Option(null, OptionFlags.Unsupported, Index.Invalid, Index.Invalid, "-zerostring", null),
                                new Option(null, OptionFlags.Ignored, Index.Invalid, Index.Invalid, "-maybezerostring", null),
#endif
                            ...
                            if (interpreter.GetOptions(options, arguments, 0, 1, Index.Invalid, true,
