                                                                    ...
                                                                    try
                                                                    {
                                                                        ...
                                                                        for (argumentIndex += 2; argumentIndex < arguments.Count; argumentIndex++)
                                                                        {
                                                                            ...
                                                                            code = Parser.SplitList(
                                                                                ...
                                                                                Length.Invalid, true, ref parameterList,
                                                                                ref result);
                                                                            ...
                                                                            if (parameterList.Count >= 1)
                                                                            {
                                                                                ...
                                                                                if (parameterList.Count >= 3)
                                                                                {
                                                                                    ...
                                                                                    if (!verbatim && (parameterValue is string))
                                                                                    {
                                                                                        ...
                                                                                        /* IGNORED */
                                                                                        Value.GetValue((string)parameterValue, valueFormat,
                                                                                            parameterValueFlags | ValueFlags.Strict,
                                                                                            dateTimeKind, interpreter.CultureInfo,
                                                                                            ref parameterValue);
                                                                                    }
                                                                                    ...
                                                                                    !String.IsNullOrEmpty(parameterList[3]))
                                                                                {
                                                                                    ...
                                                                                    code = Value.GetInteger2(parameterList[3], ValueFlags.AnyInteger,
                                                                                        interpreter.CultureInfo, ref size, ref result);
                                                                        ...
                                                                        if (code == ReturnCode.Ok)
                                                                        {
                                                                            ...
                                                                            if (time)
                                                                            {
                                                                                ...
                                                                                setCode = interpreter.SetVariableValue2(
                                                                                    ...
                                                                                    Vars.ResultSet.Prepare, microseconds.ToString(),
                                                                                    ref setError);
                                                                                ...
                                                                                case DbExecuteType.Scalar:
                                                                                    {
                                                                                        try
                                                                                        {
                                                                                            result = MarshalOps.FixupDataValue(
                                                                                                command.ExecuteScalar(), dateTimeBehavior,
                                                                                                dateTimeKind, dateTimeFormat, nullValue);
                                                                                        }
                                                                                        catch (Exception e)
                                                                                        {
                                                                                            Engine.SetExceptionErrorCode(interpreter, e);
                                                                                        ...
                                                                                        try
                                                                                        {
                                                                                            ...
                                                                                            switch (resultFormat)
                                                                                            {
                                                                                                ...
                                                                                                case DbResultFormat.RawArray:
                                                                                                    {
                                                                                                        ...
                                                                                                        code = DataOps.DataReaderToArray(
                                                                                                            ...
                                                                                                            dateTimeFormat, nullValue, limit,
                                                                                                            allowNull, pairs, names, ref count,
                                                                                                            ref result);
                                                                                                ...
                                                                                                case DbResultFormat.RawList:
                                                                                                    {
                                                                                                        ...
                                                                                                        code = DataOps.DataReaderToList(
                                                                                                            interpreter, reader, dateTimeBehavior,
                                                                                                            dateTimeKind, dateTimeFormat, nullValue,
                                                                                                            limit, nested, allowNull, pairs, names,
                                                                                                            ref list, ref count, ref result);
                                                                                                ...
                                                                                                case DbResultFormat.DataReader:
                                                                                                    {
                                                                                                        ObjectOptionType objectOptionType = ObjectOptionType.Execute |
                                                                            ...
                                                                            if (time)
                                                                            {
                                                                                ...
                                                                                setCode = interpreter.SetVariableValue2(
                                                                                    VariableFlags.None, timeVarName,
                                                                                    Vars.ResultSet.Execute, microseconds.ToString(),
                                                                                    ref setError);
                                                        ...
                                                        if (interpreter.HasDbConnections(ref result))
                                                        {
                                                            try
                                                            {
                                                                ...
                                                                code = DataOps.CreateDbConnection(interpreter,
                                                                    ...
                                                                    typeFullName, typeName, Value.GetTypeValueFlags(
                                        ...
                                        if (arguments.Count >= 4)
                                        {
                                            ...
                                            if (code == ReturnCode.Ok)
                                            {
                                                    ...
                                                    ((argumentIndex + 2) == arguments.Count))
                                                {
                                                    ...
                                                    switch (arguments[argumentIndex])
                                                    {
                                                        ...
                                                        default:
                                                            {
                                                                result = String.Format(
                                                                    "unsupported database transaction action \"{0}\"",
                                                                    arguments[argumentIndex]);
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        result = "wrong # args: should be \"sql transaction ?options? action object\"";
                                                    }
                                ...
                                case "types":
                                    {
                                        ...
                                        {
                                            IStringList list = GenericOps<DbConnectionType, string>.Combine(
