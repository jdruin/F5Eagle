                                ...
                                case "days":
                                    {
                                        if (arguments.Count >= 2)
                                        {
                                            bool build = (String.Compare(subCommand, "buildnumber", StringOps.SystemStringComparisonType) == 0);
                                            ...
                                            if (code == ReturnCode.Ok)
                                            {
                                                    ...
                                                    ((argumentIndex + 1) == arguments.Count))
                                                {
                                                    ...
                                                    if (argumentIndex != Index.Invalid)
                                                    {
                                                        ...
                                                        code = Value.GetDateTime2(
                                                            arguments[argumentIndex], format, ValueFlags.AnyDateTime,
                                                            utc ? DateTimeKind.Utc : DateTimeKind.Local,
                                                            interpreter.CultureInfo, ref dateTime, ref result);
                                                    }
                                                    else
                                                    {
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        result = String.Format(
                                                            "wrong # args: should be \"clock {0} ?options? ?dateString?\"",
                                                            subCommand);
                                                    }
                                ...
                                case "duration":
                                    {
                                        if (arguments.Count == 4)
                                        {
                                            ...
                                            code = Value.GetDateTime2(
                                                ...
                                                interpreter.DateTimeKind, interpreter.CultureInfo, ref start,
                                                ref result);
                                            ...
                                            if (code == ReturnCode.Ok)
                                            {
                                                ...
                                                code = Value.GetDateTime2(
                                                    ...
                                                    interpreter.DateTimeKind, interpreter.CultureInfo, ref end,
                                                    ref result);
                                ...
                                case "filetime":
                                    {
                                        if (arguments.Count >= 3)
                                        {
                                            ...
                                            code = Value.GetWideInteger2(arguments[2], ValueFlags.AnyWideInteger, interpreter.CultureInfo, ref fileTime);
                                            ...
                                            if (code == ReturnCode.Ok)
                                            {
                                                ...
                                                if (code == ReturnCode.Ok)
                                                {
                                                    if (argumentIndex == Index.Invalid)
                                                    {
                                                        ...
                                                        if (format != null)
                                                            result = FormatOps.TclClockDateTime(interpreter.CultureInfo,
                                ...
                                case "isvalid":
                                    {
                                        if (arguments.Count == 3)
                                        {
                                            ...
                                            code = Value.GetDateTime2(
                                                arguments[2], interpreter.DateTimeFormat, ValueFlags.AnyDateTime,
                                                interpreter.DateTimeKind, interpreter.CultureInfo, ref dateTime,
                                                ref result);
                                ...
                                case "microseconds":
                                    {
                                        if ((arguments.Count == 2) || (arguments.Count == 3))
                                        {
                                            if (arguments.Count == 3)
                                            {
                                                ...
                                                code = Value.GetDateTime2(
                                                    arguments[2], interpreter.DateTimeFormat, ValueFlags.AnyDateTime,
                                                    interpreter.DateTimeKind, interpreter.CultureInfo, ref epoch,
                                                    ref result);
...
#pragma warning restore 219
                                                    ...
                                                    code = Value.GetDateTime2(
                                                        arguments[2], format, ValueFlags.AnyDateTime,
                                                        utc ? DateTimeKind.Utc : DateTimeKind.Local,
                                                        interpreter.CultureInfo, ref dateTime, ref result);
                                ...
                                case "stop":
                                    {
                                        if (arguments.Count == 3)
                                        {
                                            ...
                                            code = Value.GetWideInteger2(
                                                (IGetValue)arguments[2], ValueFlags.AnyWideInteger,
                                                interpreter.CultureInfo, ref startCount, ref result);

                                            if (code == ReturnCode.Ok)
                                            {
                                                result = PerformanceOps.GetMicroseconds(
                                                    startCount, PerformanceOps.GetCount(), 1);
                                            }
                                        }
                                        else
                                        {
