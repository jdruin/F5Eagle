...
namespace Eagle._Commands
{
    ...
    internal sealed class Tcl : Core
    {
        ...
        private readonly EnsembleDictionary subCommands = new EnsembleDictionary(new string[] {
            ...
            "find", "interps", "load", "master", "module",
            "preserve", "queue", "ready", "recordandeval", "release",
            "resetcancel", "select", "set", "source", "subst",
                                ...
                                case "cancel":
                                    {
                                        ...
                                        if (arguments.Count >= 3)
                                        {
                                            if (interpreter.HasTclInterpreters(ref result))
                                            {
                                ...
                                case "command":
                                    {
                                                ...
                                                default:
                                                    {
                                                        result = ScriptOps.BadValue(
                                                            null, "option", arguments[2],
                                                            new string[] { "create", "delete", "exists", "list" }, null, null);
                                        ...
                                        {
                                            result = "wrong # args: should be \"tcl command arg ?arg ...?\"";
                                            code = ReturnCode.Error;
                                        }
                                        break;
                                    }
                                        ...
                                        if (arguments.Count >= 2)
                                        {
                                            ...
                                            if (code == ReturnCode.Ok)
                                            {
                                                if (argumentIndex == Index.Invalid)
                                                {
                                                    ...
                                                    if (!bridge || interpreter.HasTclBridges(ref result))
                                                    {
                                                ...
                                                if (TclApi.CheckModule(tclApi, ref result))
                                                {
                                                    if (arguments.Count == 4)
                                                    {
                                                        ...
                                                        code = Value.GetInteger2(
                                                            ...
                                                            interpreter.CultureInfo, ref line, ref result);
                                            ...
                                            if (TclApi.CheckModule(tclApi, ref result))
                                            {
                                                if (arguments.Count == 3)
                                                {
                                                    ...
                                                    code = Value.GetBoolean2(
                                                        ...
                                                        interpreter.CultureInfo, ref exceptions,
                                                        ref result);
                                ...
                                case "find":
                                    {
                                        if (arguments.Count >= 2)
                                        {
                                            bool available = (String.Compare(subCommand, "available", StringOps.SystemStringComparisonType) == 0);
                                            ...
                                            if (code == ReturnCode.Ok)
                                            {
                                                    ...
                                                    ((argumentIndex + 2) >= arguments.Count))
                                                {
                                                    ...
                                                    if (code == ReturnCode.Ok)
                                                    {
                                                        ...
                                                        code = TclWrapper.Find(
                                                            ...
                                                            minimumVersion, maximumVersion, unknownVersion,
                                                                    ...
                                                                    if (available)
                                                                    {
                                                                        if (pattern != null)
                                                                        {
                                                                            ...
                                                                            code = GenericOps<string>.FilterList(
                                                                                new StringList(builds.Keys), list,
                                                ...
                                                else
                                                {
                                                    ...
                                                    {
                                                        result = String.Format(
                                                            "wrong # args: should be \"tcl {0} ?options? ?path? ?pattern?\"",
                                                            subCommand);
                                                    }
                                ...
                                case "interps":
                                    {
                                        if ((arguments.Count == 2) || (arguments.Count == 3))
                                        {
                                            ...
                                            {
                                                if (interpreter.HasTclInterpreters())
                                                {
                                                    string pattern = null;
                                ...
                                case "master":
                                    {
                                        if (arguments.Count == 2)
                                        {
                                            ...
                                            code = interpreter.GetAnyTclMasterInterpreter(
                                        ...
                                        {
                                            result = "wrong # args: should be \"tcl master\"";
                                            code = ReturnCode.Error;
                                        }
                                        break;
                                    }
                                ...
                                case "resetcancel":
                                    {
                                        if (arguments.Count >= 3)
                                        {
                                            OptionDictionary options = new OptionDictionary(
                                                new IOption[] {
                                                new Option(null, OptionFlags.None, Index.Invalid, Index.Invalid, "-slaves", null),
                                            ...
                                            if (code == ReturnCode.Ok)
                                            {
                                                    ...
                                                    ((argumentIndex + 1) == arguments.Count))
                                                {
                                                    ...
                                                    if (TclApi.CheckModule(tclApi, ref result))
                                                    {
                                                        ...
                                                        if ((code == ReturnCode.Ok) && slaves)
                                                            code = TclWrapper.SetSlaveCancelFlags(tclApi, interp,
                                        ...
                                        if (code == ReturnCode.Ok)
                                        {
                                            if (argumentIndex == Index.Invalid)
                                            {
                                                ...
                                                code = TclWrapper.DoOneEvent(
                                                    ...
                                                    noComplain, ref count, ref tclApi,
                                                    ref result);
