...

    ...
    if {[llength [info commands exportAndImportPackageCommands]] > 0} then {
      exportAndImportPackageCommands [namespace current] [list \
          ...
          getPluginPath getPackageInstallPath appendArgs lappendArgs \
          getDictionaryValue getColumnValue getRowColumnValue tqputs \
          tqlog makeBinaryChannel makeAsciiChannel makeUnicodeChannel \
