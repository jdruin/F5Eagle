...
Components: Application\Plugins\Security; Source: {#BinLibDir}\Harpy.Basic{#AppMajorMinorVersion}\keyRing.Master.demo.eagle; DestDir: {app}\lib\Harpy.Basic{#AppMajorMinorVersion}; Flags: skipifsourcedoesntexist restartreplace uninsrestartdelete
Components: Application\Plugins\Security; Source: {#BinLibDir}\Harpy.Basic{#AppMajorMinorVersion}\keyRing.Master.demo.eagle.harpy; DestDir: {app}\lib\Harpy.Basic{#AppMajorMinorVersion}; Flags: skipifsourcedoesntexist restartreplace uninsrestartdelete
