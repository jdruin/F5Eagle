...
namespace Eagle._Extensions
{
    ...
    internal sealed class Preprocessor : PreprocessorExtension, IDisposable
    {
            ...
            )
        {
            ...
            //
            // HACK: Use a workaround for how WiX parses references to extension
            //       variables and functions (i.e. it always assumes that internal
            //       parenthesis indicate a function call).
            //
            if (name != null)
            {
                name = name.Replace(
